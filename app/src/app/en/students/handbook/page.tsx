...
const title = "Student Handbook | Biotech TTU - Tan Tao University";
const description =
  "Study, project, research and support guidance for students of the School of Biotechnology at Tan Tao University.";
