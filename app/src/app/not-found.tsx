      ...
      <main className="bg-white min-h-[60vh] flex flex-col font-sans antialiased py-20">
        <div className="flex-grow flex flex-col items-center justify-center px-6 text-center py-16">
          ...
          <div className="relative w-full max-w-xl mb-8">
            <div className="flex items-center justify-center gap-3 md:gap-6 relative z-10">
              ...
              <div className="w-24 h-24 md:w-28 md:h-28 flex items-center justify-center transform translate-y-3 relative">
                <span className="text-6xl md:text-8xl font-black text-[#139C48] select-none">
                  0
                </span>
          ...
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-6">
            <Link
              href="/"
              className="px-8 py-3 bg-[#139C48] text-white font-bold rounded-full shadow-lg hover:shadow-[#139C48]/20 hover:-translate-y-0.5 transition-all flex items-center gap-2 text-sm"
            >
              Quay lại Trang Chủ
            ...
            <a
              ...
              className="text-[#1A1A1A] font-semibold hover:text-[#139C48] transition-colors flex items-center gap-2 py-1 border-b-2 border-transparent hover:border-[#139C48] text-sm"
            >
              Liên hệ hỗ trợ
