    ...
    >
      <div className="relative w-full max-w-3xl shadow-[0_22px_70px_rgba(15,23,42,0.3)]">
        <button
          ...
          className="absolute right-2 top-2 z-10 flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-[#171b25]/90 text-white shadow-[0_8px_24px_rgba(15,23,42,0.28)] backdrop-blur-md transition-all duration-200 hover:scale-105 hover:bg-[#139C48] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#171b25] sm:-right-4 sm:-top-4"
        ...
        <a
          ...
          onClick={dismissBanner}
          className="group block cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#139C48]"
          aria-label={`${title}. ${
            openInNewTab
              ? isEnglish
                ? "Opens in a new tab"
