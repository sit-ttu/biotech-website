              ...
              >
                <h3>
                  ...
                  >
                    ...
                    <span
                      aria-hidden
                      className="flex h-9 w-9 items-center justify-center justify-self-end border border-[#139C48]/35 text-xl font-light leading-none text-[#139C48] transition-colors group-hover:bg-[#139C48] group-hover:text-white"
                    >
                      {isOpen ? "−" : "+"}
                    </span>
                  </button>
